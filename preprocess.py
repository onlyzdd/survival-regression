...
if __name__ == "__main__":
    ...
    train_ids = pd.read_csv('train_gs.dat', sep='\t', header=None).sample(n=10000, random_state=args.seed)[0]
    ...
    df_test_scores.loc[test_ids].to_json(os.path.join(output_dir, 'test.json'))
